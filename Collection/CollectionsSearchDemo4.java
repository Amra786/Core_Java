...
public class CollectionsSearchDemo4 {
	...
	System.out.println(Collections.binarySearch(l,10,new MyComparator7()));//2
	System.out.println(Collections.binarySearch(l,13,new MyComparator7()));//-3
